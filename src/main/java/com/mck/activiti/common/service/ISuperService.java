...
public interface ISuperService<T> extends IService<T> {
     ...
     * @throws Exception
     */
    boolean updateIdempotency(T entity, DistributedLock locker, String lockKey, Wrapper<T> countWrapper, String msg) throws Exception;
     ...
     * @throws Exception
     */
    boolean updateIdempotency(Wrapper<T> updateWrapper, DistributedLock locker, String lockKey, Wrapper<T> countWrapper, String msg) throws Exception;
}
